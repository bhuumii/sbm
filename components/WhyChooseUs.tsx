...
export const WhyChooseUs = ({ title, customerFeatures, manufacturerFeatures }: WhyChooseUsProps) => {
  ...
  <div className="container mx-auto px-4 sm:px-6 text-center relative z-10">
        ...
        <div className={`flex justify-center gap-2 mb-12 transform transition-all duration-700 ease-out ${
          ...
          <div className={`relative ${isDark ? "bg-gray-800" : "bg-gray-100"} p-1 rounded-full shadow-inner`}>
            <button 
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 text-left max-w-7xl mx-auto">
          {featuresToShow.map((feature, index) => (
            ...
            >
              <div className={`group relative ${
              ...
              } p-8 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 border overflow-hidden min-h-[250px] flex flex-col justify-start`}>
                ...
                <div className="relative z-10 flex-grow">
                  ...
                  } leading-relaxed transition-colors duration-300 text-sm md:text-base`}>
                    {feature.description}
                  </p>
                </div>
                ...
                } to-transparent rounded-bl-full transform translate-x-8 -translate-y-8 group-hover:translate-x-6 group-hover:-translate-y-6 transition-transform duration-500`}></div>
              </div>
            </div>
          ))}
        </div>
