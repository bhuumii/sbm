      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
          ...
          <div className="bg-white p-8 rounded-lg shadow-md text-center flex flex-col items-center">
            ...
            <h3 className="text-lg font-bold text-blue-800 mb-2">HEAD OFFICE</h3>
            <p className="text-gray-600 whitespace-pre-wrap">{info.address || 'Address not available'}</p>
          </div>
          ...
          <div className="bg-white p-8 rounded-lg shadow-md text-center flex flex-col items-center">
            ...
            <a href={`tel:${info.phone}`} className="text-gray-600 hover:text-blue-700">
          ...
          <div className="bg-white p-8 rounded-lg shadow-md text-center flex flex-col items-center">
            ...
            <a href={`mailto:${info.email}`} className="text-gray-600 hover:text-blue-700">
