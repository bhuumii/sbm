  ...
  return (
    <section className="bg-white py-16 md:py-24">
      <div className="container mx-auto px-6 text-center">
        <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-12">{title || 'From Our Gallery'}</h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
          {images.map((item) => (
            <div key={item._id} className="block w-full aspect-square overflow-hidden rounded-lg shadow-lg">
              <Image
                src={item.imageUrl}
